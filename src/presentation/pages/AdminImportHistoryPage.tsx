...
const S: Record<string, React.CSSProperties> = {
  ...
  hint: { color: "#a6adc8", fontSize: "0.875rem" },
  ...
  th: { padding: "0.6rem 1rem", textAlign: "left" as const, color: "#a6adc8", fontSize: "0.75rem", fontWeight: 700, textTransform: "uppercase" as const, letterSpacing: "0.05em", borderBottom: "1px solid #313244", backgroundColor: "#181825", whiteSpace: "nowrap" as const },
  ...
  opBadge: { backgroundColor: "#1e1e2e", border: "1px solid #313244", borderRadius: "4px", padding: "0.15rem 0.5rem", fontSize: "0.78rem", color: "#cba6f7" },
};
