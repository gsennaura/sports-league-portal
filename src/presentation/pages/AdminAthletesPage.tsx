...
const S: Record<string, React.CSSProperties> = {
  ...
  filterSelect: { backgroundColor: "#1e1e2e", border: "1px solid #313244", borderRadius: "6px", color: "#cdd6f4", fontSize: "0.875rem", padding: "0.55rem 0.75rem", outline: "none", minWidth: "150px" },
  searchWrap: { display: "flex", gap: "0.5rem", marginBottom: "1.25rem" },
  searchInput: { flex: 1, backgroundColor: "#1e1e2e", border: "1px solid #313244", borderRadius: "6px", color: "#cdd6f4", fontSize: "0.9rem", padding: "0.55rem 0.9rem", outline: "none" },
  ...
  th: { backgroundColor: "#181825", color: "#cdd6f4", fontWeight: 600, fontSize: "0.84rem", textAlign: "left", padding: "0.75rem 1rem", borderBottom: "1px solid #313244", whiteSpace: "nowrap" },
