    ...
    <>
      <header style={S.hero}>
        ...
        <div style={S.heroInner}>
          ...
          <h1 style={S.title}>Novo Clube</h1>
        </div>
      </header>
      <main style={S.page}>
        <form onSubmit={handleSubmit} style={S.form} noValidate>
          ...
          {success && <p style={S.successMsg}>✔ Clube cadastrado! Redirecionando...</p>}

          <div style={S.actions}>
            <Link to="/admin/clubes" style={S.btnCancel}>Cancelar</Link>
            <button type="submit" style={S.btnSubmit} disabled={submitting || logoLoading}>
