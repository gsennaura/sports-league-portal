...
const S: Record<string, React.CSSProperties> = {
  ...
  label: { fontSize: "13px", color: "#a6adc8", marginBottom: "6px" },
...
export function AdminRegistrationsPage({
  ...
  return (
    ...
    <div style={S.page}>
      ...
      <div style={S.card}>
        {loadingOptions ? (
          <p style={{ color: "#a6adc8", fontSize: "14px" }}>Carregando opções...</p>
        ) : (
        ...
        <div style={S.card}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
            <span style={{ fontSize: "15px", fontWeight: 600, color: "#cdd6f4" }}>
              Atletas
              {rows.length > 0 && (
                <span style={{ fontSize: "13px", fontWeight: 400, color: "#a6adc8", marginLeft: "10px" }}>
                    ...
                    >
                      ...
                      <td style={S.td}>
                        {row.status === "registered" && row.registration ? (
                          ...
                          <span style={{ color: "#6c7086", fontSize: "12px" }} title="Clube pode não estar filiado à liga ou o time não participa desta edição.">
                            Não elegível
                          </span>
                        ) : (
